...
class test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, HODNOTA)
    ...
    def set_HODNOTA(self, HODNOTA):
        self.HODNOTA = HODNOTA
        self.analog_const_source_x_0.set_offset(self.HODNOTA)
