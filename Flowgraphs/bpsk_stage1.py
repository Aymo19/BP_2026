...
class bpsk_stage1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_float*1, 64)
        ...
        self.ErTools_BitErrorRate_0 = ErTools.BitErrorRate(64, 1, 8, 0, 16)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.ErTools_BitErrorRate_0, 1), (self.blocks_stream_to_vector_0, 0))
        self.connect((self.ErTools_BitErrorRate_0, 0), (self.digital_constellation_decoder_cb_0_0, 0))
        self.connect((self.ErTools_BitErrorRate_0, 1), (self.qtgui_histogram_sink_x_0, 0))
        self.connect((self.analog_fastnoise_source_x_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.analog_random_source_x_0, 0), (self.ErTools_BitErrorRate_0, 1))
        ...
        self.connect((self.blocks_char_to_float_0, 0), (self.blocks_throttle2_1, 0))
        self.connect((self.blocks_char_to_float_0_0, 0), (self.blocks_throttle2_1_0, 0))
        ...
        self.connect((self.blocks_throttle2_1, 0), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.blocks_throttle2_1_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.digital_constellation_decoder_cb_0, 0), (self.ErTools_BitErrorRate_0, 2))
