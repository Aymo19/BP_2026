...
class Test_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Test_1")
        ...
        self.qtgui_time_sink_x_1_1_0.set_update_time(1)
        self.qtgui_time_sink_x_1_1_0.set_y_axis(-3, 3)
        ...
        self.qtgui_time_sink_x_1_1.set_update_time(1)
        ...
        self.blocks_add_xx_1 = blocks.add_vii(1)
        ...
        self.analog_noise_source_x_1 = analog.noise_source_i(analog.GR_GAUSSIAN, 1, 0)
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_GAUSSIAN, 1, 0)
        self.ErTools_BitErrorRate_0 = ErTools.BitErrorRate(8, 1, 8, 0, 16)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.ErTools_BitErrorRate_0, 1), (self.qtgui_histogram_sink_x_0, 0))
        self.connect((self.ErTools_BitErrorRate_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.ErTools_BitErrorRate_0, 1), (self.qtgui_time_sink_x_1_1, 0))
        self.connect((self.ErTools_BitErrorRate_0, 1), (self.qtgui_time_sink_x_1_1_0, 0))
        ...
        self.connect((self.analog_random_source_x_0, 0), (self.blocks_add_xx_1, 0))
        self.connect((self.analog_random_source_x_0, 0), (self.blocks_int_to_float_0_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_throttle2_1, 0))
        self.connect((self.analog_sig_source_x_1, 0), (self.ErTools_BitErrorRate_0, 0))
        self.connect((self.analog_sig_source_x_1, 0), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_int_to_float_0, 0))
        self.connect((self.blocks_float_to_char_0, 0), (self.ErTools_BitErrorRate_0, 2))
        self.connect((self.blocks_float_to_char_0_0, 0), (self.ErTools_BitErrorRate_0, 1))
        self.connect((self.blocks_int_to_float_0, 0), (self.blocks_float_to_char_0, 0))
        self.connect((self.blocks_int_to_float_0_0, 0), (self.blocks_float_to_char_0_0, 0))
...
def main(top_block_cls=Test_1, options=None):
