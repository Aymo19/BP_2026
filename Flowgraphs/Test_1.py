...
class Test_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_0.set_update_time(2)
        ...
        self.qtgui_histogram_sink_x_0_0.set_update_time(2)
        ...
        self.blocks_throttle2_1 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "items" == "auto" else max( int(float(5) * samp_rate) if "items" == "time" else int(5), 1) )
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_histogram_sink_x_0, 0))
        ...
        self.connect((self.blocks_throttle2_1, 0), (self.qtgui_histogram_sink_x_0_0, 0))
