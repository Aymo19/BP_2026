...
class Test_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_noise_source_x_0 = analog.noise_source_c(analog.GR_GAUSSIAN, 1, 5)
        ...
        self.connect((self.ErTools_AWGN_kanal_0, 1), (self.blocks_int_to_float_0, 0))
        self.connect((self.ErTools_AWGN_kanal_0, 0), (self.qtgui_time_sink_x_0_1, 0))
        self.connect((self.analog_noise_source_x_0, 0), (self.blocks_add_xx_0_0, 1))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_throttle2_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_add_xx_0_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
