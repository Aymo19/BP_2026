...
class Test_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Test_2")
        ...
        self.qtgui_time_sink_x_0_1_0.set_update_time(2)
        self.qtgui_time_sink_x_0_1_0.set_y_axis(-3, 3)
        ...
        self.blocks_throttle2_1_0 = blocks.throttle( gr.sizeof_char*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_throttle2_1 = blocks.throttle( gr.sizeof_char*1, samp_rate, True, 0 if "items" == "auto" else max( int(float(5) * samp_rate) if "items" == "time" else int(5), 1) )
        self.blocks_float_to_char_0 = blocks.float_to_char(1, 1)
        self.blocks_char_to_float_1 = blocks.char_to_float(1, 1)
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint((-2), 0, 100))), True)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_noise_source_x_0, 0), (self.blocks_float_to_char_0, 0))
        self.connect((self.analog_random_source_x_0, 0), (self.blocks_throttle2_1, 0))
        self.connect((self.blocks_char_to_float_1, 0), (self.qtgui_histogram_sink_x_0, 0))
        self.connect((self.blocks_char_to_float_1, 0), (self.qtgui_time_sink_x_0_1_0, 0))
        self.connect((self.blocks_float_to_char_0, 0), (self.blocks_throttle2_1_0, 0))
        self.connect((self.blocks_throttle2_1, 0), (self.blocks_xor_xx_0, 0))
        self.connect((self.blocks_throttle2_1_0, 0), (self.blocks_xor_xx_0, 1))
...
def main(top_block_cls=Test_2, options=None):
